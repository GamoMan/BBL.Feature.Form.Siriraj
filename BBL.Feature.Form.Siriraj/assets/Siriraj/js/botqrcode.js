...
var ID_PREFIX = '|'
var ID_SUFFIX = '00'+0x0d
var ID_TRANSACTION_TYPE = '2'+0x0d
var ID_CR = 0x0d
...
function generatePayload() {
    var data = ID_PREFIX + taxid + ID_SUFFIX + ref1 + ID_CR + ref2 + ID_CR + formatAmount(amount) + ID_CR + ID_TRANSACTION_TYPE + duedate + ID_CR + qty + ID_CR + saleamount + ID_CR + formatAmount(rate) + ID_CR + formatAmount(vat) + ID_CR + seller + ID_CR + buyer + ID_CR + name + ID_CR + ref3 + ID_CR + proxy + ID_CR + formatAmount(net) + ID_CR + income + ID_CR + taxrate + ID_CR + taxamount + ID_CR + taxcond + ID_CR;
}
